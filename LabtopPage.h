...
namespace Group25MyBusinessProject {
	...
	/// <summary>
	/// Summary for LabtopPage
	/// </summary>
	public ref class LabtopPage : public System::Windows::Forms::Form
	{
	public:
		LabtopPage(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(LabtopPage::typeid));
			...
			this->ClientSize = System::Drawing::Size(831, 498);
			this->Controls->Add(this->panel1);
			this->FormBorderStyle = System::Windows::Forms::FormBorderStyle::None;
			this->Name = L"LabtopPage";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"LabtopPage";
